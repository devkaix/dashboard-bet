...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      excel_uploads: {
        Row: { analysis_month: string | null; detected_months: string[] | null; error_message: string | null; expected_file_type: string | null; file_hash: string | null; file_type: string | null; filename: string; id: string; month_validation_status: string | null; normalized_hash: string | null; period_end: string | null; period_start: string | null; processed_at: string | null; rows_processed: number | null; status: string | null; storage_path: string | null; uploaded_at: string | null; validation_report: Json | null; validation_status: string | null }
        Insert: { analysis_month?: string | null; detected_months?: string[] | null; error_message?: string | null; expected_file_type?: string | null; file_hash?: string | null; file_type?: string | null; filename: string; id?: string; month_validation_status?: string | null; normalized_hash?: string | null; period_end?: string | null; period_start?: string | null; processed_at?: string | null; rows_processed?: number | null; status?: string | null; storage_path?: string | null; uploaded_at?: string | null; validation_report?: Json | null; validation_status?: string | null }
