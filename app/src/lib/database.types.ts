  ...
  public: {
    Tables: {
      daily_network_stats: {
        Row: {
          bet: number | null
          bet_bonus: number | null
          buy_in: number | null
          buy_in_bonus: number | null
          created_at: string | null
          date: string
          id: string
          jackpot: number | null
          jackpot_won: number | null
          overlay: number | null
          payout: number | null
          rake: number | null
          refund: number | null
      ...
      daily_player_game_stats: {
        ...
        Relationships: [
          {
            foreignKeyName: "daily_player_game_stats_game_type_id_fkey"
      ...
      excel_uploads: {
        Row: {
          ...
          detected_months: string[] | null
          error_message: string | null
          expected_file_type: string | null
      ...
      player_username_aliases: {
        ...
        Relationships: [
          {
            foreignKeyName: "player_username_aliases_player_id_fkey"
            columns: ["player_id"]
            isOneToOne: false
            referencedRelation: "players"
            referencedColumns: ["id"]
      ...
      pvr_mapping_audit: {
        Row: {
          ...
          id: string
          new_pvr_id: string
          players_already_correct: number
          players_changed: number
          players_previously_null: number
          players_reassigned: number
          previous_pvr_id: string | null
          pvr_ref_code: string
          reason: string | null
      ...
      tickets: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tickets_pvr_id_fkey"
            columns: ["pvr_id"]
            isOneToOne: false
            referencedRelation: "pvrs"
            referencedColumns: ["id"]
    ...
    Functions: {
      preview_pvr_mapping: {
        Args: { p_pvr_id: string; p_reference_code: string }
        Returns: Json
      }
      sync_pvr_assignments: { Args: never; Returns: undefined }
      verify_pvr_mapping: {
        Args: { p_pvr_id: string; p_reason?: string; p_reference_code: string }
        Returns: Json
      }
    }
    Enums: {
